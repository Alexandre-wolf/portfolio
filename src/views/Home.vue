<template>
  <div class="home">
        ...
        <div class="row">
          <div class="col-lg-8 mx-auto">
            ...
            <div class="text-light">
              <p class="exo2 about-desc">Je m'appelle Alexandre Wolf, développeur web et d'applications Java âgé de 21 ans, résidant à Lansargues (un petit village très sympa). Passionné par l'innovation technologique, en particulier dans le domaine de l'intelligence artificielle, je suis reconnu pour mon dévouement et mon professionnalisme dans tout projet entrepris. Ma capacité à apporter une énergie positive et une approche proactive fait de moi un collaborateur apprécié.</p>
              <p class="exo2 about-desc">Titulaire d'un baccalauréat STI2D option Système d'Information et Numérique, et actuellement en 3ème année de BUT informatique à l'IUT de Montpellier, je poursuis mes études avec sérieux et engagement. En tant que personne sociable et loyale, je valorise les relations humaines au sein d'un environnement professionnel dynamique. Cependant, je suis également conscient de l'importance de maintenir un équilibre entre vie professionnelle et personnelle.</p>
            </div>
    ...
    <!-- Timeline Section -->
    <section id="timeline" class="py-5 bg-dark">
      <div class="container">
    ...
    <section id="projects" class="py-5 bg-dark">
      <div class="container">
        <h2 class="text-white mb-4">Projets</h2>
        <div class="row g-4">
          <div v-for="project in projects" :key="project.id" class="col-md-6 col-lg-4">
            <div class="card bg-darker h-100">
              <div class="card-body">
                ...
                <p class="card-text text-light">{{ project.shortDescription }}</p>
                <div class="mb-3">
                  <span 
                    v-for="tech in project.mainTechnologies" 
                    :key="tech" 
